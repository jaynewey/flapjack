...
class TileMap:
    ...
    def remove_tile(self, chunk_key, layer_index, x, y):
        print(self.chunks)
        self.chunks[chunk_key]["layers"][layer_index][y][x] = -1
        self._render_tile(x, y, -1, self.chunk_surfaces[chunk_key][layer_index], remove=True)
